		...
		<div class="row">
			...
			<div class="col-sm-5 col-lg-4">
				<div class="login-copytext">
					<h2>Welcome to <i class="fa fa-university fa-logo"></i><span class="logo-text">Alexa Bank </span></h2>
					<p> Log in to access your checking, savings, credit cards, and mortgage accounts with Alexa Bank.</p>
					<h2>Online Payments</h2>
					<p>Using your Alexa Bank account, you can pay your bills like electricity, telephone, satellite television, mobile phone etc. You can also pay your insurance premium, credit card bills etc.</p>
				</div>
			</div>
		</div>
	</div>
